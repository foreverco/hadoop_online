  ...
  <div class="lvcontainer applyListBox">
    <div class="checkBox">
      <div class="zmBox">
        <p>品种:</p>
        <ul>
          <li v-for="(item, index) in zmList" :key="index">{{ item.name }}</li>
        </ul>
      </div>
      <div class="btnBox">
        <p>搜索:</p>
        <div class="headSearch">
          <el-input v-model="drugName" placeholder="请输入关键字"></el-input>
      ...
      <div class="isselBox">
        ...
        <ul>
          <li v-if="areaCheck && areaCheck.length > 0">
            ...
            <i
              class="el-icon-close"
              @click="checkForm.orginProvinceId = ''"
            ></i>
          </li>
          <li v-if="ckareaCheck && ckareaCheck.length > 0">
            ...
            <i
              class="el-icon-close"
              @click="checkForm.warehouseProvinceId = ''"
            ></i>
          </li>
          <li v-if="radiocheck && radiocheck.length !== 0">
            <span>质量</span>
            <span>|</span>
