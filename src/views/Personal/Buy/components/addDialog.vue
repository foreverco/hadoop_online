      ...
      <el-form label-width="80px">
        <el-row>
          ...
          <el-col :span="11" :push="2">
            ...
            <el-form-item
              v-if="dialogData.statusName === '审核未通过'"
              label="审核意见:"
            >
              <p
                style="width:100%;color:red;border:1px solid red;height:50px;padding-left:10px"
              >
                {{ failMsg }}
              </p>
            </el-form-item>
            <el-form-item label="温馨提示:" v-else>
...
export default {
  ...
  methods: {
    ...
    findGoto() {
      ...
      } else if (this.dialogData.statusName === "审核中") {
        this.$message.warning("此商品正在审核中，无法修改相关信息");
      }
    }
  }
};
